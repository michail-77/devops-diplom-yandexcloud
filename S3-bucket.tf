...
provider "yandex" {
  # Укажите свои учетные данные или используйте другие методы аутентификации
}

resource "yandex_iam_service_account_key" "storage_key" {
  service_account_id = "your_service_account_id_here"  # Укажите идентификатор сервисного аккаунта
